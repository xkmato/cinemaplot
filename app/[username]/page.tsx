...
// Import the profile components and dependencies
...
export default function UsernameProfilePage() {
    ...
    // Use the same profile logic as the original component
    ...
    useEffect(() => {
        const fetchUserByUsername = async () => {
            ...
            try {
                // Check if username exists in the usernames registry
                const usernameDoc = await getDoc(
                    doc(db, `artifacts/cinemaplot/public/data/usernames`, username.toLowerCase())
                );

                if (usernameDoc.exists()) {
                    const data = usernameDoc.data();
                    setProfileUid(data.uid);
                } else {
                    setNotFound(true);
                    setLoading(false);
                }
    ...
    // Load profile data when UID is available
    React.useEffect(() => {
    ...
    const handleEditField = (field: string) => {
        // Don't allow username editing on username route
    ...
    const handleSaveField = async (field: string) => {
        ...
        // Username editing is not allowed on username route
        if (field === 'username') {
            return;
        }
    ...
    // Share functionality - always use username URL since we're on username route
            ...
            <div className="min-h-screen bg-background flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                        The username &quot;{username}&quot; doesn&apos;t exist or has been removed.
                    </p>
    ...
    // Render the same profile UI as the original component
    return (
                            ...
                            <Card className="p-6">
                                ...
                                <div className="flex flex-col items-center text-center mb-6">
                                    ...
                                    <div className="w-full">
                                        ...
                                        {/* Username - show as read-only since this is the username route */}
                                        <div className="mb-4">
